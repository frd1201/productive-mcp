...
export const updateTaskStatusDefinition = {
  ...
  description:
    'Update the status of a task in Productive.io using workflow status ID. Use list_workflow_statuses to see available status IDs.',
  inputSchema: {
    type: 'object',
    properties: {
      task_id: {
      ...
      workflow_status_id: {
        type: 'string',
        description:
          'ID of the workflow status to set (use list_workflow_statuses to see available options)',
      },
    },
