...
const sprintValueSchema = z.union([z.string(), z.array(z.string())]);

const updateTaskSprintSchema = z.object({
  task_id: z.string().describe('ID of the task to update'),
  sprints: sprintValueSchema.describe(
    'Sprint number(s) like "S03" or ["S03", "S04"]. Use empty array [] or null to remove all sprints',
  ),
});
